package com.sparkarabic.authservice.config.mongodb;

import com.sparkarabic.authservice.domain.MongoAccessToken;
import com.sparkarabic.authservice.domain.MongoRefreshToken;
